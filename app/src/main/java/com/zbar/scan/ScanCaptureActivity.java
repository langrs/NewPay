...
//	private Button scanRestart;
	...
	public static Intent getStartIntent(Context context, String scanTips) {
		Intent intent = new Intent(context, ScanCaptureActivity.class);
		intent.putExtra("tips", scanTips);
		return intent;
	}
	...
	private void findViewById() {
		...
		scanTips = (TextView) findViewById(R.id.capture_scan_tips);
	...
	private void initViews() {
		...
		if (TextUtils.isEmpty(tips)) {
			scanTips.setVisibility(View.GONE);
		} else {
			scanTips.setText(tips);
